...
<%!String disciplinas = "/home/siena/workspace/AVA/WebContent/data/ghramos/disciplinas.json";
	...
	String passwd = "/home/siena/workspace/AVA/WebContent/data/ghramos/passwd.json";
	...
	<div class="main" id="myMain">
		<div class="main-center">
			...
			<div class="box box-info">
				<div class="box-header with-border">Informações de Contato</div>
				<form class="" action="index.html" method="post">
					<div class="box-body">
						<div class="form-group">
							<label class="control-label">Código de Pessoa:</label>
							<div class="">
								<input type="text" name="idpessoa"
									value="<%out.println(getValor("idpessoa"));%>" disabled>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="">
								<input type="text" name="firstname"
									value="<%out.println(getValor("pnome"));%>" disabled>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="">
								<input type="text" name="surname"
									value="<%out.println(getValor("snome"));%>" disabled>
							</div>
						</div>
					</div>
				</form>
			...
			<div class="box box-info">
				<div class="box-header">Informações Adicionais</div>

				<form class="" action="atualizaPerfil.jsp" method="post">
					<div class="box-body">
						<div class="form-group">
							<label class="control-label">Skype:</label>
							<div class="loginWidth">
								<input type="text" name="inputSkype"
									value="<%out.println(getValor("skype"));%>">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">Facebook:</label>
							<div class="">
								<input type="text" name="inputFace"
									value="<%out.println(getValor("facebook"));%>">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">Twitter:</label>
							<div class="">
								<input type="text" name="inputTwitter"
									value="<%out.println(getValor("twitter"));%>">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">Homepage:</label>
							<div class="">
								<input type="text" name="inputHome"
									value="<%out.println(getValor("homepage"));%>">
							</div>
						</div>
					</div>
					<div class="box-footer">
						<button type="submit" class="blue loginWidth" name="salvar">Salvar</button>
					</div>
				</form>
			</div>
			<footer>
				<a class="center">AVA</a>
				<br>
				<br>
				<br>
			</footer>
